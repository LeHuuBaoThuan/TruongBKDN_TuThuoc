...
#define R4_IN_Pin GPIO_PIN_2
#define R4_IN_GPIO_Port GPIOB
#define R4_IN_EXTI_IRQn EXTI2_IRQn
#define R3_IN_Pin GPIO_PIN_10
#define R3_IN_GPIO_Port GPIOB
#define R3_IN_EXTI_IRQn EXTI15_10_IRQn
#define R2_IN_Pin GPIO_PIN_11
#define R2_IN_GPIO_Port GPIOB
#define R2_IN_EXTI_IRQn EXTI15_10_IRQn
#define R1_IN_Pin GPIO_PIN_12
#define R1_IN_GPIO_Port GPIOB
#define R1_IN_EXTI_IRQn EXTI15_10_IRQn
#define C4_OUT_Pin GPIO_PIN_13
#define C4_OUT_GPIO_Port GPIOB
#define C3_OUT_Pin GPIO_PIN_14
#define C3_OUT_GPIO_Port GPIOB
#define C2_OUT_Pin GPIO_PIN_15
#define C2_OUT_GPIO_Port GPIOB
#define C1_OUT_Pin GPIO_PIN_8
